...
export const Notification = (
  ...
  const {
    setDiv: setDivTwo, getDiv: getDivTwo, removeDiv: removeDivTwo
  } = useDiv();

  const {
    setDiv: setDivThree, getDiv: getDivThree, removeDiv: removeDivThree
  } = useDiv();

  const {
    setDiv: setDivFour, getDiv: getDivFour, removeDiv: removeDivFour
  } = useDiv();

  const {
    setDiv: setDivFive, getDiv: getDivFive, removeDiv: removeDivFive
  } = useDiv();

  const {
    setButton, getButton, removeButton
  } = useButton();
